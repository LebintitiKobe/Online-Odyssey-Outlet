...
- Adjust for return , stock-outs , discounts , ratings/reviews \[Done\]
  , Product appeal .
...
Product brands / Categories rank by our growth rates of Net Units sold ,
...
What are the additional resources (data , people , access permission)
needed in order to get our minimum viable solution ?

- Here we need sales data for november and december , in which we can be
  able for find and calculate all the metric mentioned in our final
  metric set and find necessary growth rates need to rank our products .

- Also we will need data recorded for products that were returned after
  they were bought from the online store .

- Also we will need data we can use to augment our data with stock-out
  and discount periods for different products .

For these identify the people and access permission that may be need to
get these data .

In our case , the data is provided for us . And its the only data that
is available to us .
...
- Clean bought november and december data
- Transform the data to product level with all necessary metric
  calculated .
- Then merge the clean versions of november and december data in order
  to be able to calculate our growth rates of each product from november
  to december .
- Apply our necessary filters , then rank the products to present to our
  stakeholders .
